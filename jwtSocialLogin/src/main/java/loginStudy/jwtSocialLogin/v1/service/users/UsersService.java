package loginStudy.jwtSocialLogin.v1.service.users;

import java.util.Collections;
import java.util.concurrent.TimeUnit;
import loginStudy.jwtSocialLogin.domain.users.Authority;
...
import loginStudy.jwtSocialLogin.dto.users.UsersResponseDto;
import loginStudy.jwtSocialLogin.jwt.JwtTokenProvider;
import loginStudy.jwtSocialLogin.v1.repository.users.UsersRepository;
import loginStudy.jwtSocialLogin.security.SecurityUtil;
...
public class UsersService {
	...
	public ResponseEntity<?> login(UsersRequestDto.Login login) {
